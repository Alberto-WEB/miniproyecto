...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'miniproyecto-backup'),
    ...
    'notifications' => [
        ...
        'mail' => [
           /*  'to' => 'alberto.guzman.220793@gmail.com',
        ...
        'slack' => [
            'webhook_url' => 'https://hooks.slack.com/services/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',
